...
async def create_event_type(ctx, client, event_msg, hr_min_array):
    ...
    # await channel.send(
    #     "Now give me the start time on the start date and the end time on the end date for this event.\n"
    #     + "Make sure you include 'am' or 'pm' so I know the range of your event, \n"
